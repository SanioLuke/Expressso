...
(30, 'Lenovo Ideapad C340 Intel Core I3 8th Gen', 'Lenovo', 'https://images-na.ssl-images-amazon.com/images/I/81Q4lF7e6HL._SL1500_.jpg', 65990, '4.1', '1200 reviewed', '100+ answered', 'When inspiration strikes, turn to the powerful yet light IdeaPad C340. It has an all-day battery and you can use it as a laptop, tablet, and more. For extra privacy, it has a webcam shutter. And you can use a digital pen with it, too giving you more ways to express yourself.', 'Processor: 8th Generation Core Intel I3-8145U processor, 2.1 Ghz base speed, 3.9 Ghz max speed, 2 cores, 4Mb smart Cache\r\nOperating System: Preloaded Windows 10 Home, with lifetime validity\r\nDisplay: 14-inch screen with (1920X1080) full HD display | Anti Glare technology\r\nMemory and Storage: 4 GB RAM | Storage 256 GB SSD\r\nDesign and battery: Thin and light Laptop |Laptop weight 1.65kg | Battery life upto: 8 hours\r\nThis genuine Lenovo Laptop comes with 1 year onsite domestic warranty from Lenovo covering manufacturing defects and not covering physical damage. For more details, see Warranty section\r\nPre-Installed Software: Windows 10 Home, Office Home and Student 2019 | Inside the box: Laptop, Charger, User Manual\r\nPorts and Optical drive: 2 USB 3.0 | 1 Type C (USB 3.0) | 1 HDMI 2.0 | 4-in-1 card reader (SD,SDHC,SDXC,MMC) | Combo audio and microphone jack | Without Optical-drive | Without LAN port');
